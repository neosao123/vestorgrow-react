                    ...
                    >
                      ...
                      <div className="FeedUserChatHead">
                        <div className="FeedUserChatName d-flex justify-content-between">
                                ...
                                <ul className="dropdown-menu dropdown-menu-end" style={{ zIndex: 999 }}>
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      <span style={{ fontSize: "18px", marginLeft: "5px" }}>{copiedText !== window.location.origin + "/groupinvite/" + item?._id
                                        ? "Invite via link"
                                        : "Link is copied"}</span>
                                    </a>
                                  </li>}
                          ...
                          {!presentInGroup && <div>
                            {isPrivateChat && groupChat && <button>Request</button>}
                            {!isPrivateChat && groupChat && <button>Join</button>}
                          </div>
