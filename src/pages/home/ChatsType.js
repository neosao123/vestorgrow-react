  ...
  return (
    <>
      <div className="feedChatBox stickyChatBox" style={{ position: "fixed", right: 0, top: `${atTop ? "6vh" : bottom}` }} >
        <div className="feedChatContent" style={{ borderTopLeftRadius: "15px", borderTopRightRadius: "15px", height: "92%", width: "18.6em", borderRadius: "none", boxShadow: "rgba(0, 0, 0, 0.24) 0px 3px 8px" }} >
